...
public class AnimatedGround extends ControlableObject implements ObjectAnimation {
    int delay=6,numFrame=0,animationLength=0,count=0;
    private BufferedImage[] frames;
    private SpriteHandler sp;
    public AnimatedGround(String name) {
    ...
    public void setFrameState(int state,int fram){
        ...
        frames=sp.getCutSheetGround(state,fram);
    }
}
